        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <%
                    ...
                    ResultSet rs=smt.executeQuery("select empname,designation,email,mobile from employee where empid='"+empid+"' ");
                    String empname=null,designation=null,email=null,mobile=null;
                    while(rs.next())
                    {
                ...
                <div class="span9" id="content">
					...
					<form action="ProcessServlet" method="post" class="form-horizontal" autocomplete="off">
  							...
  							<div class="control-group" style="margin-top: 30px">
  								...
  								<div class="controls">
  									<input type="text" name="empName" value="<%=empname%>" data-required="1" required="required" class="span6 m-wrap"/>
  								</div>
  							</div>
  							<div class="control-group" style="margin-top: 30px">
  								...
  								<div class="controls">
  									<input name="empEmail" type="email" value="<%=email%>" required="required" class="span6 m-wrap"/>
  								</div>
  							</div>
  							<div class="control-group">
  								<label class="control-label">Mob Number<span class="required">*</span></label>
  								<div class="controls">
  									<input name="empMob" type="text" value="<%=mobile%>" required="required" pattern="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" title="Please enter 10 digit number only" class="span6 m-wrap"/>
  								</div>
  							</div>
