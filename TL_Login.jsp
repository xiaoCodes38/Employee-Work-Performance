  ...
  <nav class="navbar navbar-inverse">
  			<div class="container-fluid" >
    			...
    			<ul class="nav navbar-nav">
      				...
      				<li class="active"><a href="TL_Login.jsp">Team Leader</a></li>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="LoginServlet" method="post">
        ...
        <input type="text" name="tlusername" class="input-block-level" placeholder="Username">
        <input type="password" name="tlpassword" class="input-block-level" placeholder="Password">
       ...
       <input type="hidden" name="action" value="TeamLeaderLogin">
