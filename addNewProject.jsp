            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
					...
					<form action="ProcessServlet" method="post" class="form-horizontal" autocomplete="off">
								...
								ResultSet rs1=smt1.executeQuery("select projectname from customer");
					
								%> 
                             	<div class="control-group" style="margin-top: 30px">
                                          <label class="control-label" for="select01">Project Name<span class="required">*</span></label>
                                          <div class="controls">
                                            <select name="projectName" class="span4 m-wrap" >
                                             <%while(rs1.next()) 
                                            {
                                            %>
  								...
  								<div class="controls">
  									<input type="text" name="clientName" data-required="1" required="required" class="span6 m-wrap"/>
  								</div>
  							</div>
  							<div class="control-group">
  								<label class="control-label">Mob Number<span class="required">*</span></label>
  								<div class="controls">
  									<input name="clientMob" type="text" required="required" pattern="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" title="Please enter 10 digit number only" class="span6 m-wrap"/>
  								</div>
  							</div>
  							<div class="control-group">
                                          <label class="control-label" for="date01">Deal Date <span class="required">*</span></label>
                                          <div class="controls" class="span6 m-wrap">
                                            <input type="date" name="dealDate"  pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}" required="required" id="date01" >
                                </div>
                                        </div>
                             <div class="control-group">
                                          <label class="control-label" for="date01">Deadline Date <span class="required">*</span></label>
                                          <div class="controls" class="span6 m-wrap">
                                            <input type="date" name="deadlineDate"  pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}" required="required" id="date01" >
                                </div>
                                        </div>                        
                 ...
                 <%
                                    ...
                                    ResultSet rs=smt.executeQuery("select project_id,project_name,client_name,client_mob,deal_date,deadline_date from project");
                                   ...
                                   <div class="table-toolbar">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2" >
                						...
                						<tr class="odd gradeX">
                    						...
                    						<td><%=rs.getDate(5) %></td>
                    						<td><%=rs.getDate(6) %></td>
                    						<td><a href="updateProject.jsp?id=<%=rs.getString(1)%>">Update</a></td>
