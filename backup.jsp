        ...
        <div class="container-fluid">
            <div class="row-fluid">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><font size="5" color="black">Complete Project Backup</font></div>
                            </div>
				...
				<div class="span12">
					...
					String team=null,project=null;
					Statement s=con.createStatement();
					ResultSet r=s.executeQuery("select team_name,project_name from assignproject where complition=100");
					while(r.next())
					{
						team=r.getString(1);
					...
					<form action="BackupServlet" method="post" class="form-horizontal" autocomplete="off"  >
                             ...
                             <div class="control-group" style="margin-top: 30px">
                                ...
                                <input type="hidden" name="action" value="taskBackup">
  								<div class="form-actions ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  										<button type="submit" class="btn btn-primary"><i class="icon-thumbs-up"></i>  Backup </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
